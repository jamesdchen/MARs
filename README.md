...
For cluster (SGE/SLURM) execution of Tier 2 runs that exceed local capacity, MARs integrates with [`hpc-agent`](https://github.com/jamesdchen/hpc-agent) — see [`docs/hpc/setup.md`](docs/hpc/setup.md).
